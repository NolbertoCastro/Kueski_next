function Cancelacion({showCancelacion, displayCancelacion}) {
  return (
    <div className={"w-[100vw] min-h-screen justify-center absolute z-20 bg-black/50 p-16 " + (showCancelacion ? "flex" : "hidden")}>
        <section className="Form">
            <div className="flex justify-between items-center">
                <h1 className=" text-4xl ">Cancelación</h1>
                <button className="h-[50px] bg-white border-0 ">
                    <img src="https://firebasestorage.googleapis.com/v0/b/nolbertocastroweb.appspot.com/o/button.png?alt=media&token=470e1b7a-7a01-454b-9cce-0bfdeaf12681" alt="close" className="h-full object-contain" onClick={e => displayCancelacion(e)}></img>
                </button>
            </div>
            <section className="grid gap-8">
                ...
                <textarea value="Velit recusandae non voluptas earum est aut non. Laborum illum reprehenderit ratione sunt natus qui a dolorem eaque architecto rem. Officia beatae voluptatum impedit ut rem dicta suscipit. Et modi et doloribus qui non at animi sed quia et. Aut itaque sit rerum excepturi sit facilis odit eius eveniet aperiam suscipit aliquam enim." className="w-full min-h-[200px] text-lg p-8 outline-0 borders break-words appearance-none"/>
